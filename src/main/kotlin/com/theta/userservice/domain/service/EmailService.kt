...
class EmailService(val mailSender: JavaMailSender, val userService: UserService, val confirmationTokenService: ConfirmationTokenService, val resetPasswordTokenService: ResetPasswordTokenService) {
    ...
    fun sendForgotPasswordEmail(emailDto: EmailDto) : ResponseMessageDto {
        ...
        val msg2 = "\n" +
                ...
                "                   <table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" background=\"https://tklyee.stripocdn.email/content/guids/CABINET_621dd5dccf4f6787e98a586b2cebf383/images/3071622474072133.png\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-image:url(https://tklyee.stripocdn.email/content/guids/CABINET_621dd5dccf4f6787e98a586b2cebf383/images/3071622474072133.png);background-repeat:no-repeat;background-position:left bottom\" role=\"presentation\"> \n" +
                "                     <tr style=\"border-collapse:collapse\"> \n" +
                "                      <td align=\"center\" style=\"padding:0;Margin:0\"><h1 style=\"Margin:0;line-height:60px;mso-line-height-rule:exactly;font-family:Righteous, sans-serif;font-size:50px;font-style:normal;font-weight:bold;color:#FFFFFF\">Reset your password</h1></td> \n" +
                "                     </tr> \n" +
                "                     <tr style=\"border-collapse:collapse\"> \n" +
                "                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:30px\"><p style=\"Marhrgin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:23px;color:#FFFFFF;font-size:15px\">Oh, it seems that you forgot your password, well that happens to the best of us!<br><br><strong>Click on the button below to reset your password.</strong></p></td> \n" +
                "                     </tr> \n" +
                "                     <tr style=\"border-collapse:collapse\"> \n" +
                "                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:30px;padding-bottom:30px;font-size:0px\"><a target=\"_blank\" href=\"https://theta-risk.com\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFFFFF;font-size:14px\"><img class=\"adapt-img\" src=\"https://media.giphy.com/media/KbbXTKvnOPVftTqHcX/giphy.gif\" alt style=\"display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic\" width=\"560\"></a></td> \n" +
                "                     </tr> \n" +
                "                     <tr style=\"border-collapse:collapse\"> \n" +
                "                      <td align=\"center\" style=\"padding:0;Margin:0;padding-top:35px;padding-bottom:35px\"> \n" +
                "                       <!--[if mso]><a href=\"https://theta-risk.com\" target=\"_blank\" hidden>\n" +
                "\t<v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" esdevVmlButton href=\"https://theta-risk.com\" \n" +
                "                style=\"height:28px; v-text-anchor:middle; width:71px\" arcsize=\"0%\" stroke=\"f\"  fillcolor=\"#ffffff\">\n" +
                "\t\t<w:anchorlock></w:anchorlock>\n" +
                "\t\t<center style='color:#333333; font-family:arial, \"helvetica neue\", helvetica, sans-serif; font-size:8px; font-weight:700; line-height:8px;  mso-text-raise:1px'>RESET</center>\n" +
                "\t</v:roundrect></a>\n" +
                "<![endif]--> \n" +
                "                       <!--[if !mso]><!-- --><span class=\"msohide es-button-border\" style=\"border-style:solid;border-color:#DD3AE7;background:#1a1428;border-width:0px;display:inline-block;border-radius:0px;width:auto;mso-hide:all\"><a href=\"${baseUrl}${resetPasswordToken.resetPasswordToken}/reset\" class=\"es-button es-button-1\" target=\"_blank\" style=\"mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#333333;font-size:18px;border-style:solid;border-color:#FFFFFF;border-width:0px 5px;display:inline-block;background:#FFFFFF;border-radius:0px;font-family:arial, 'helvetica neue', helvetica, sans-serif;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center\">RESET</a></span> \n" +
                "                       <!--<![endif]--></td> \n" +
                "                     </tr> \n" +
                "                   </table></td> \n" +
                "                 </tr> \n" +
                ...
                "                   <table cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" role=\"presentation\" style=\"mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px\"> \n" +
                "                     <tr style=\"border-collapse:collapse\"> \n" +
                "                      <td style=\"padding:0;Margin:0\"><p style=\"Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#FFFFFF;font-size:14px\">In case the button doesn't work we have a workaround!</p><a href=\"RESETLINK\" style=\"-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFFFFF;font-size:14px\">RESET LINK</a></td> \n" +
                "                     </tr> \n" +
                "                   </table></td> \n" +
                "                 </tr> \n" +
                "               </table></td> \n" +
                ...
                " </body>\n" +
                "</html>"
        sendMail("no-reply@theta-risk.com", user.email, "Password reset", msg2)
